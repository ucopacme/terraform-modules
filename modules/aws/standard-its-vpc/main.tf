...
module "vpc" {
  ...
  source = "git::https://git@github.com/ucopacme/terraform-module.git//modules/aws/vpc?ref=v0.0.1"
...
module "vpc_public_subnets" {
  ...
  new_bits           = "2"
  source = "git::https://git@github.com/ucopacme/terraform-module.git//modules/aws/vpc_subnets?ref=v0.0.1"
...
module "vpc_route_table" {
  ...
  source = "git::https://git@github.com/ucopacme/terraform-module.git//modules/aws/route_table?ref=v0.0.1"
  tags    = merge(var.tags, map("Name", var.name))
  vpc_id  = module.vpc.vpc_id
}
...
module "vpc_route_table_main_route_table_association" {
  ...
  source = "git::https://git@github.com/ucopacme/terraform-module.git//modules/aws/main_route_table_association?ref=v0.0.1"
  tags           = merge(var.tags, map("Name", var.name))
...
module "vpc_igw" {
  ...
  source = "git::https://git@github.com/ucopacme/terraform-module.git//modules/aws/internet_gateway?ref=v0.0.1"
  tags    = merge(var.tags, map("Name", var.name))
  vpc_id  = module.vpc.vpc_id
}
...
module "vpc_route_for_igw" {
  ...
  source = "git::https://git@github.com/ucopacme/terraform-module.git//modules/aws/route?ref=v0.0.1"
  tags                   = merge(var.tags, map("Name", var.name))
