...
module "vpc_subnets_tgw_attachment" {
  ...
  source = "git::ssh://git@github.com/ucopacme/terraform-module.git//modules/aws/tgw_attachment?ref=v0.0.1"
...
module "vpc_subnets_tgw_attachment_tgw_route_table_association" {
  ...
  source = "git::ssh://git@github.com/ucopacme/terraform-module.git//modules/aws/tgw_route_table_association?ref=v0.0.1"
